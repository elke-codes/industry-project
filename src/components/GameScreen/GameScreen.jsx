	...
	return (
		<div className="game-screen">
			<div className="game-screen__button-containers">
				<Link to="/lobby">
					<button className="game-screen__button-back">Back</button>
				</Link>
			...
			<div className="game-screen__lobby">
				<div className="game-screen__task">
					<p className="game-screen__content-task">
						Let me tell you about my startup. It is basically
			...
			<div className="game-screen__task-option">
				...
				<div className="game-screen__option-card">
					<p className="game-screen__option-card-text">
						A Hydroflask.
					</p>
				</div>
				<div className="game-screen__option-card">
